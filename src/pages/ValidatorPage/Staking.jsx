      ...
      <Box component="main" sx={{ flexGrow: 1, width: "100%", minWidth: 0 }}>
        ...
        <Box p={3}>
          <Stack direction={{ xs: 'column', md: 'row' }} spacing={3}>
            {/* Card Quản lý staking */}
            <Card
              sx={{
                flex: 1,
                background: 'linear-gradient(135deg, #e0f7fa 0%, #fceabb 100%)',
                boxShadow: '0 4px 32px #20bf6b33',
                borderRadius: 4,
                border: '2px solid #20bf6b22',
                minWidth: 320
              }}
            >
              <CardContent>
                <Stack direction="row" alignItems="center" gap={1} mb={2}>
                  ...
                  <Typography variant="h6" fontWeight={700} sx={{ color: '#20bf6b', textShadow: '0 2px 8px #fff8' }}>
                    Quản lý staking
                  </Typography>
                </Stack>
                ...
                <Button
                  ...
                  color="primary"
                  sx={{
                    mt: 2, mb: 2, fontWeight: 700, borderRadius: 2,
                    boxShadow: '0 2px 8px #20bf6b44', fontSize: 16
                  }}
                ...
                <TableContainer
                  ...
                  sx={{
                    ...
                    background: 'linear-gradient(120deg, #ffe0e3 0%, #fffbe0 100%)',
                    border: '2px solid #e5393522',
                    mt: 1
                  }}
                >
                  <Table size="small">
                    ...
                    <TableBody>
                      {slashingHistory.length === 0 ? (
                        <TableRow>
                          <TableCell colSpan={4} align="center" sx={{ color: '#aaa', fontStyle: 'italic' }}>
                            Không có lịch sử slashing
                          </TableCell>
                        </TableRow>
                        ...
                        <TableRow key={idx} hover>
                          ...
                          <TableCell>
                            <Chip
                              ...
                              sx={{ fontWeight: 700, fontSize: 15, px: 1.5, bgcolor: '#ffebee', color: '#e53935' }}
                            />
                          </TableCell>
            ...
            {/* Card Thông tin staking */}
            <Card
              sx={{
                flex: 1,
                background: 'linear-gradient(135deg, #f8ffae 0%, #43cea2 100%)',
                boxShadow: '0 4px 32px #43cea233',
                borderRadius: 4,
                border: '2px solid #43cea222',
                minWidth: 320
              }}
            >
              <CardContent>
                <Stack direction="row" alignItems="center" gap={1} mb={2}>
                  ...
                  <Typography variant="h6" fontWeight={700} sx={{ color: '#43cea2', textShadow: '0 2px 8px #fff8' }}>
                    Thông tin staking
                  </Typography>
                </Stack>
          ...
          <Dialog open={openDialog} onClose={handleCloseDialog} maxWidth="xs" fullWidth>
            ...
            <DialogActions>
              ...
              <Button onClick={handleWithdraw} variant="contained" color="primary" disabled={withdrawAmount <= 0}>
                Xác nhận
              </Button>
            </DialogActions>
          </Dialog>
