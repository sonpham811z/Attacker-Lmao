          ...
          >
            <CardContent>
              <Typography
                ...
                fontWeight={700}
                mb={2}
                sx={{ color: '#20bf6b', textShadow: '0 2px 8px #fff8' }}
              >
              ...
              >
                <Table>
                  ...
                  <TableBody>
                    {filtered.length === 0 ? (
                      <TableRow>
                        <TableCell colSpan={5} align="center" sx={{ color: '#aaa', fontStyle: 'italic' }}>
                          Không có request nào phù hợp
                        </TableCell>
                      </TableRow>
                    ) : filtered.map((req) => (
                      <TableRow
                      ...
                      >
                        <TableCell>
                          <Chip
                            ...
                            color="info"
                            variant="outlined"
                            sx={{ fontWeight: 700, fontSize: 15, px: 1.5, bgcolor: '#e3f2fd', color: '#1976d2' }}
                          />
                        </TableCell>
                        <TableCell>
                          <Chip
                            ...
                            color="default"
                            variant="outlined"
                            sx={{ fontWeight: 700, fontSize: 15, px: 1.5, bgcolor: '#f3e5f5', color: '#6a1b9a' }}
                          />
                        </TableCell>
                        <TableCell>
                          <Chip
                            ...
                            color="primary"
                            variant="outlined"
                            sx={{ fontWeight: 700, fontSize: 15, px: 1.5, bgcolor: '#e8f5e9', color: '#388e3c' }}
                          />
                        </TableCell>
                        <TableCell>
                          <Chip
