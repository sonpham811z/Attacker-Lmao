  ...
  return (
    <Card sx={{ mb: 2 }}>
      <CardContent>
        ...
        {isConnected && (
          <Box mt={2}>
            {/* Đăng ký mới: chỉ khi chưa từng đăng ký, chưa stake, chưa bị cấm */}
            ...
            {/* Đang hoạt động: chỉ hiện nút dừng hoạt động khi đang active */}
            {isActive && slashedCount < 3 && (
              <>
            ...
            {/* Tái kích hoạt: chỉ khi đã từng stake, không active, chưa bị cấm */}
            {!isActive && slashedCount < 3 && stakedAmount !== '0' && (
              <>
                <button
            ...
            {/* Rút stake: chỉ khi không active, chưa bị cấm, đã từng stake */}
            {!isActive && slashedCount < 3 && stakedAmount !== '0' && (
              <>
                <button
            ...
            {/* Nếu bị cấm vĩnh viễn (slashedCount >= 3) */}
            {slashedCount >= 3 && (
              <Typography variant="body2" color="error" fontWeight={700} mt={2}>
                Bạn đã bị cấm vĩnh viễn khỏi hệ thống Validator.
              </Typography>
            )}
          </Box>
        )}
